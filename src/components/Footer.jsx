...
const Footer = () => {
  return (
    <footer className="bg-sky-600 text-gray-300 pt-12 pb-6"> {/* Changed from text-gray-300 to text-gray-200 */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <h3 className="text-white text-lg font-semibold mb-4">EventSphere</h3>
            <p className="text-gray-200 text-sm leading-relaxed"> {/* Changed to text-gray-200 for better visibility */}
              Empowering event organizers with cutting-edge ticketing solutions since 2015.
            </p>
            <div className="flex items-start space-x-3 text-gray-200"> {/* Changed to text-gray-200 and increased space-x */}
              <FiMapPin className="mt-0.5 flex-shrink-0 text-blue-400" /> {/* Added mt for alignment and blue accent */}
              <span className="text-sm">123 Event Street, San Francisco, CA 94107</span>
            </div>
            <div className="flex items-start space-x-3 text-gray-200"> {/* Changed to text-gray-200 and increased space-x */}
              <FiPhone className="mt-0.5 flex-shrink-0 text-blue-400" /> {/* Added mt for alignment and blue accent */}
              <span className="text-sm">+1 (800) 555-1234</span>
            </div>
            <div className="flex items-start space-x-3 text-gray-200"> {/* Changed to text-gray-200 and increased space-x */}
              <FiMail className="mt-0.5 flex-shrink-0 text-blue-400" /> {/* Added mt for alignment and blue accent */}
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><a href="/about" className="text-gray-300 hover:text-white transition text-sm">About Us</a></li>
              <li><a href="/find-events" className="text-gray-300 hover:text-white transition text-sm">Browse Events</a></li>
              <li><a href="/create-event" className="text-gray-300 hover:text-white transition text-sm">Create Event</a></li>
              <li><a href="/pricing" className="text-gray-300 hover:text-white transition text-sm">Pricing</a></li>
              <li><a href="/blog" className="text-gray-300 hover:text-white transition text-sm">Blog</a></li>
              <li><a href="/careers" className="text-gray-300 hover:text-white transition text-sm">Careers</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><a href="/help-center" className="text-gray-300 hover:text-white transition text-sm">Help Center</a></li>
              {/* <li><a href="/faq" className="text-gray-300 hover:text-white transition text-sm">FAQs</a></li> */}
              <li><a href="/contact" className="text-gray-300 hover:text-white transition text-sm">Contact Us</a></li>
              <li><a href="/privacy" className="text-gray-300 hover:text-white transition text-sm">Privacy Policy</a></li>
              <li><a href="/terms" className="text-gray-300 hover:text-white transition text-sm">Terms of Service</a></li>
              <li><a href="/refund" className="text-gray-300 hover:text-white transition text-sm">Refund Policy</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm"> {/* Added text-gray-300 */}
              Subscribe to our newsletter for the latest event trends and platform updates.
            </p>
            ...
            <div className="flex space-x-4 pt-2">
              <a href="#" className="text-white hover:text-blue-400 transition"> {/* Changed from text-gray-400 */}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="text-xs text-gray-400 mb-4 md:mb-0"> {/* Changed from text-gray-500 to text-gray-400 */}
            &copy; {new Date().getFullYear()} EventSphere, Inc. All rights reserved.
          </div>
          <div className="flex space-x-6">
            <a href="/accessibility" className="text-xs text-gray-400 hover:text-white transition">Accessibility</a>
            <a href="/sitemap" className="text-xs text-gray-400 hover:text-white transition">Sitemap</a>
            <a href="/security" className="text-xs text-gray-400 hover:text-white transition">Security</a>
            <a href="/trust" className="text-xs text-gray-400 hover:text-white transition">Trust & Safety</a>
          </div>
        </div>
