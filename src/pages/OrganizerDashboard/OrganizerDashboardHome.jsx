...
//               conference. We saw a 40% increase in attendance and saved dozens
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12">
          <div>
            ...
            <p className="text-lg text-gray-600 mt-2">
              Welcome back! Manage your conferences and track their success.
            </p>
          </div>
          <div className="mt-4 md:mt-0">
            <button
              ...
              aria-label="Create new conference"
            >
              <FiPlus className="mr-2" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-sky-200 p-8 flex flex-col hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-gray-600 mb-6 flex-grow">
              Full control over every detail of your conference setup, perfect
            ...
            <button
              ...
              aria-label="Start creating conference"
            >
              Get Started
              <FiArrowRight className="ml-2" />
            </button>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-sky-200 p-8 flex flex-col hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-gray-600 text-sm mb-6">
              A complete profile increases conference discoverability by 40% and
          ...
          <div className="lg:col-span-2 bg-white rounded-xl shadow-lg border border-sky-200 p-6">
            <div className="flex justify-between items-center mb-6">
              ...
              <a
                ...
                aria-label="View all conferences"
              >
                View All
              </a>
            </div>
