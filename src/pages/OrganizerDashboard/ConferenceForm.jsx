...
const OrganizerDashboardCreate = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Selected Event Type:", form.eventType);
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        <div className="bg-white shadow-lg rounded-lg overflow-hidden p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Event Type Dropdown */}
            <div>
              <label className="block text-gray-700 font-semibold mb-1" htmlFor="eventType">
                Select Event Type
              </label>
              <select
                name="eventType"
            ...
            {/* Event Name */}
            <div>
              <label className="block text-gray-700 font-semibold mb-1" htmlFor="eventName">
                Event Name
              </label>
              <input
                type="text"
