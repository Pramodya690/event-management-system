...
import ReverveVenue from "./ReserveVenue";
  ...
  const handleNext = async () => {
    ...
    try {
      for (const type of Object.keys(tickets)) {
        ...
        console.log("→ About to save tickets for eventId:", form.eventId);
          ...
          <AnimatePresence mode="wait">
            ...
            {currentStep === 2 && (
              <SeatAllocationPage 
                ...
                // seatMapPreview={seatMapPreview}
                setSeatMapPreview={setSeatMapPreview} />
            )}
            {currentStep === 3 && (
              <StallAllocationPage
                form={form}
                setForm={setForm}
                eventId={form.eventId}
                setStallMapPreview={setStallMapPreview}
            ...
            {currentStep === 5 && (
              <PublishEvent
                ...
                stallMapPreview={stallMapPreview}
                layoutURL={layoutURL}
                seatMapPreview={seatMapPreview}
                agenda={agenda}
              />
